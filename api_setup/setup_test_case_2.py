                ...
                [
                    Area("House 1",
                         [
                             ...
                             Area("battery_1", strategy=StorageStrategy(
                                 initial_soc=50,
                    ...
                    Area("House 2",
                         [
                             ...
                             Area("battery_2", strategy=StorageStrategy(
                                 initial_soc=50,
                                 battery_capacity_kWh=10,
                                 max_abs_battery_power_kW=10,
                                 final_buying_rate=16.99,
                    ...
                    Area("House 3",
                         [
                             ...
                             Area("battery_3", strategy=StorageStrategy(
                                 initial_soc=50,
                                 battery_capacity_kWh=10,
                                 max_abs_battery_power_kW=10,
                                 final_buying_rate=16.99,
                    ...
                    Area("House 4",
                         [
                             ...
                             Area("battery_4", strategy=StorageStrategy(
                                 initial_soc=50,
                                 battery_capacity_kWh=10,
                                 max_abs_battery_power_kW=10,
                                 final_buying_rate=16.99,
